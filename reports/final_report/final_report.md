...
Browser fingerprinting libraries are then explored, and the ethics behind these techniques are later covered in as part of the Professional Issues section. Two solutions are identified and demonstrated. 

An analysis of the communication technology is then included, looking firstly at MIFARE and latterly and the Bluetooth Low Energy specification and Web Bluetooth APIs. Alternatives and issues are discussed. 
...
There are two commonly used and freely available libraries for calculating browser fingerprints - Fingerprint2 [@v_valve/fingerprintjs2_2020] and @noauthor_clientjs_nodate, the latter of which implements some of Fingerprint2. 
